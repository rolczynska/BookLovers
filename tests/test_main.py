...
def test_search_books():
    ...
    book.add_to_searching_list("365 dni", "olkiewicz.alex1234@gmail.com", path)
...
def test_check_availability():
    ...
    book.add_to_searching_list("365 dni", "olkiewicz.alex1234@gmail.com", path)
    book.add_to_searching_list("365 dni", "olkiewicz.alex1234@gmail.com", path)
    book.add_to_searching_list("gdzie śpiewają raki", "olkiewicz.alex1234@gmail.com", path)
...
def test_send_email_notify():
    ...
    book.add_to_searching_list("365 dni", "olkiewicz.alex1234@gmail.com", path)
    book.add_to_searching_list("365 dni", "olkiewicz.alex1234@gmail.com", path)
    book.add_to_searching_list("Kobieta w walizce", "olkiewicz.alex1234@gmail.com", path)
