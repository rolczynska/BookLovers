...
def send_register_confirmation(title, email):
    ...
    cancel_notification = f"If you want to cancel your subscription for this book please click on <a href='http://127.0.0.1:5000/cancel_notify/{title}/{email}'>THIS LINK.</a>"
